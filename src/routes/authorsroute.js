...
authorsRouter.post('/delete', function (req, res) { //Part #2 Point 9 //change post to delete
...
authorsRouter.post('/edit', function (req, res) { //Part #2 Point 9 //change post to put
...
authorsRouter.post('/update', function (req, res) { //Part #2 Point 9 //change post to put
