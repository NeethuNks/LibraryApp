...
booksRouter.post('/delete', function (req, res) { //Part #2 Point 9 //change post to delete
...
//router to edit book
booksRouter.post('/edit', function (req, res) { //Part #2 Point 9 //change post to put
...
booksRouter.post('/update', function (req, res) { //Part #2 Point 9 //change post to put
